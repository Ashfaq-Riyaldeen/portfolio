...
/*
 * Brand icons are inlined (Simple Icons path data, CC0) because lucide-react
 * v1+ no longer ships brand logos.
 */

type IconProps = { className?: string };

function brand(path: string): ComponentType<IconProps> {
...
/** Icon for a social platform name, falling back to a globe. */
